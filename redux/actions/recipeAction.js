...
export const fetchIndian = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://api.edamam.com/api/recipes/v2?type=public&q=&app_id=53f9c771&app_key=4fcebc5db45c3a7aac2e1b746c3052fe&cuisineType=indian&imageSize=LARGE&random=true`
    );
